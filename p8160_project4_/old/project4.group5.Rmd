...
# Starting 'a'
beta.a = matrix(c(seq(0.0001,0.005,(0.005 - 0.0001)/6),seq(0.0002,0.006,(0.006 - 0.0002)/6),seq(0.0003,0.007,(0.007-0.0003)/6)),nrow = 3, byrow =  T)
...
result = MHstep.reg(para.init = start, a = a, logdens = log.density,iter = 400)
